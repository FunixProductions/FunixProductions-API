...
public class PaypalOrderService implements PaypalOrderClient {
    ...
    private ApiException handleFeignException(final FeignException e, final String action) {
        try {
            ...
            log.error("Impossible {} un ordre d'achat avec PayPal. Message Erreur {}. Details: {} MessageBuilder: {}", action, e.getMessage(), (error != null && error.getDetails() != null ? error.getDetails() : ""), errorMessage, e);
